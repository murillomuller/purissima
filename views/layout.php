...
<body class="bg-gray-50 min-h-screen">
    ...
    <div id="main-content" class="lg:pl-64 transition-all duration-300 ease-in-out">
        <!-- Top Bar -->
        <div class="bg-gradient-to-r from-white to-gray-50 shadow-lg border-b border-gray-200 px-6 py-6 sticky top-0 z-40 sticky-header max-w-full">
            <div class="flex items-center justify-between header-content">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold text-primary"><?= $title ?? 'Dashboard' ?></h1>
                            <p class="text-gray-600 text-sm mt-1">Purissima Saúde Personalizada</p>
                        </div>
                    </div>
                </div>
                <div class="flex items-center space-x-4">
